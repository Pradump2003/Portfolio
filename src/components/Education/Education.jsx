...
export default function Education() {
  return (
    <Element name="education">
      <div id="education" className="flex flex-col items-center pt-8 sm:pt-16">
        <h1 className="text-white font-castoro font-medium text-3xl sm:text-5xl">
          Education
        </h1>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 sm:gap-20 mt-8 sm:mt-14 px-4 sm:px-14 w-full max-w-5xl">
          {/* Left Column */}
